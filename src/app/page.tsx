...
export default function Page() {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset>
      <SidebarTrigger className=" lg:hidden sm:block " />
              ...
              <div className="flex lg:flex-row flex-col mt-10">
                <div className="flex flex-col">
                  <p className="text-sm font-normal mb-2">
                    Copilot has pinpointed 20 keyleads that shows strong
                    purchase intent and actively engaging. This needs your focus
                  </p>
                  <Carousel />
                </div>
                <div className="flex flex-col">
